 ...
 *6)emptycol         */
static const char *colors[] = {"#8c644c","#332d29","#7a8c5c","#ff6666","#cc9933","#181512","#000000"};
/*
...
static const uint8_t borders[] = {3,5,2,4};
...
static key keys[] = {
  ...
  {  MOD ,              XK_w,          focusnext,         {.i=0}},
  {  MOD |SHIFT,        XK_w,          focusnext,         {.i=1}},
  // Kill a window
